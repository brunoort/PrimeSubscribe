...
app.get('/subscription/:cpf', function (req, res) {
    ...
    if (reqHeader.wctoken !== "" && reqHeader.wctoken !== null) {
        ...
        getCustomerInfo(reqHeader.wctoken, reqHeader.wctrustedtoken).then(res => {
            console.log('customerResponse', res);
            ...
            if (customerInfoCPF == customerCPF) {
                ...
                res.status(400).end(JSON.stringify({
                    message: 'Não foi possível recuperar sua assinatura, CPF Inválido',
                    statusCode: 120,
                    data: null
                }));
            }
